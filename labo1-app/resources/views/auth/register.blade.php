...
<html lang="en">
  <head>
    ...
    />
    <link rel="styleshet" href="{{  asset('assets/estilos.css')}}">
  </head>
          ...
          <div class="col-sm-6 text-black">
            ...
            <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
              ...
              <form style="width: 23rem;">
                ...
                <h3 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Crear tu cuenta</h3>
              ...
              <form action="{{route('register')}}" method="POST">
                ...
                <div data-mdb-input-init class="form-outline mb-4">
                    <input type="password_confirmation" id="form2Example28" class="form-control form-control-lg" />
                    <label class="form-label" for="form2Example28">Confirma tu contraseña</label>
                  </div>
                ...
                <p>Iniciar <a href="{{route('login')}}" class="link-info">Te puedes Iniciar Sesion aqui</a></p>
